...
const MUSIC: CulturalSeed[] = [
  ...
  { id: "yorushika-video", contentKind: "Music", title: "Yorushika — image, weather, and distance", publisher: "Yorushika Official", sourceUrl: "https://www.youtube.com/watch?v=9ypEFXTakV8", youtubeId: "9ypEFXTakV8", level: "B2", angle: "how recurring natural images give a music catalogue a recognisable atmosphere" },
  { id: "kiikiii-visual", contentKind: "Music", title: "KiiiKiii — playful image systems", publisher: "KiiiKiii Official", sourceUrl: "https://www.youtube.com/watch?v=hAEfi_SKTEU", youtubeId: "hAEfi_SKTEU", level: "B1", angle: "how styling and graphic motifs make a new group immediately identifiable" },
  { id: "illit-visual", contentKind: "Music", title: "ILLIT — hair, gesture, and concept", publisher: "HYBE LABELS / ILLIT", sourceUrl: "https://www.youtube.com/watch?v=Vk5-c_v4gMU", youtubeId: "Vk5-c_v4gMU", level: "B1", angle: "how one styling choice can carry more concept than an overloaded set" },
  { id: "akg-official", contentKind: "Music", title: "Asian Kung-Fu Generation — graphic continuity", publisher: "AKG Official", sourceUrl: "https://www.youtube.com/watch?v=Tz3HO-1JCkY", youtubeId: "Tz3HO-1JCkY", level: "B2", angle: "how cover art, typography, and video tone can stay coherent across years" },
];
...
const MOVIES: CulturalSeed[] = [
  ...
  { id: "perfect-days", contentKind: "Movie", title: "Perfect Days — noticing repetition", publisher: "NEON", sourceUrl: "https://www.youtube.com/watch?v=QzZBbX5A1FA", youtubeId: "QzZBbX5A1FA", level: "B1", angle: "how repeated routines reveal changes that dialogue never announces" },
  { id: "monster-koreeda", contentKind: "Movie", title: "Monster — one event, several truths", publisher: "Well Go USA", sourceUrl: "https://www.youtube.com/watch?v=xoviKDGaLao", youtubeId: "xoviKDGaLao", level: "B2", angle: "how perspective changes the emotional meaning of the same incident" },
